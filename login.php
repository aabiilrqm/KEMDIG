<?php
session_start();
include 'db.php'; // pastikan file ini berisi koneksi mysqli ke database 'perpustakaan'
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['user'] === 'admin' && $_POST['pass'] === '123') {
        ...
        $nama = $_POST['user'];     // dari input name="user"
        $password = $_POST['pass']; // dari input name="pass"
    ...
    <div class="login-container">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input type="text" name="user" class="form-control-modern" placeholder="Nama" required>
            </div>
